                                  ...
                                  load: function(resp) {
                                      ...
                                      switch(method) {
                                        ...
                                        dojo.forEach(resp, function(track){
                                             ...
                                             var content = '<div><a href="'+ track.url +'">' +
                                                            track.artist.text + '' + 
                                                            track.name + 
                                             ...
                                             var src = track.image[1].text;

                                             if(src == "") {src = "css/defaultImage.png";}                                                                    

                                             var image = dojo.create('img',{src: src});
                                        ...
                                        dojo.forEach(resp, function(artist){
                                             ...
                                             var content = "<div><a href='"+artist.url+"'>" + artist.name +"</a>" + " <span><a href='#'>(" + artist.playcount+ " plays)</a></span></div>";

                                             var elem = dojo.create('div',{innerHTML: content, 'class': 'tweetBox'});
                                             
                                             var src = artist.image[1].text;
